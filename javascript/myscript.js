...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim Anh đang đập nhanh quá rồi!" + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tim Anh đập nhanh như vậy là tại vì:';
document.querySelector('.Description .modal-body').innerHTML = 'Anh thích Em nhiều lắm nè Moaa:33 <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/Dylan2k4'>Dylan<a>";
